            ...
            <button type="button" class="dropdown-toggle flex items-center">
                <div class="flex-shrink-0 w-10 h-10 relative">
                    <div class="p-1 bg-white rounded-full focus:outline-none focus:ring">
                        <img class="w-8 h-8 rounded-full" src="{{asset('dist/img/profile-dafault.png')}}" alt=""/>
...
{{-- <div class="bg-gray-100 text-gray-700 py-2 px-6">
    <p class="text-sm">You are currently in: <span class="font-semibold">{{ $activePage }}</span></p>
</div> --}}